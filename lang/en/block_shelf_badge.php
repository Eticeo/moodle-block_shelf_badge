<?php
/**
 * Strings for component 'block_shelf_badge', language 'en', branch 'MOODLE_30_STABLE'
 *
 * @package    block
...
$string['learnerview'] = 'Learner view';
$string['trainerview'] = 'Trainer view';
$string['managerview'] = 'Manager view';

$string['firstconnexionlabel'] = 'First connexion';
$string['totallabeltime'] = 'Total Time';
$string['hours'] = 'hours';
